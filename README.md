...
for the vehicle longitudinal and lateral behavior. The controller gets the position
and the rotation error from a simulator as input and controls the **vehicle behavior** with well tuned cost-functions.
